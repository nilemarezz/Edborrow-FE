...
describe("reducers/Item", () => {
  ...
  describe("GETALL_ITEM_SUCCESS", () => {
    it("should return the state with all items", () => {
      expect(
        reducer(undefined, {
          type: types.GETALL_ITEM_SUCCESS,
  ...
  describe("ITEM_LOADING", () => {
    it("should return the state with loading items", () => {
      expect(
        reducer(undefined, { type: types.ITEM_LOADING, payload: true })
      ).toEqual({
        Items: [],
        Cart: [],
        loading: true,
  ...
  describe("DELETE_ITEM_INCART", () => {
      ...
      it("it should return the state with one item in cart", () => {
        expect(
          reducer(
            ...
            { type: types.DELETE_ITEM_INCART, payload: 1 }
          )
        ).toEqual({
          Items: [],
          Cart: [{ itemId: 2 }],
    ...
    describe("if there is only one item in cart and delete that item", () => {
      it("it should return the state with no item in array", () => {
        expect(
          reducer(
            { Items: [], Cart: [{ itemId: 2 }], loading: null, filter: [] },
            { type: types.DELETE_ITEM_INCART, payload: 2 }
          )
        ).toEqual({
          Items: [],
          Cart: [],
    ...
    describe("if there are no item in cart and delete item", () => {
      it("it should return the state with no item in array", () => {
        expect(
          reducer(
            { Items: [], Cart: [], loading: null, filter: [] },
            { type: types.DELETE_ITEM_INCART, payload: 2 }
          )
        ).toEqual({
          Items: [],
    ...
    describe("if there is one item in cart and delete iwrong itemId", () => {
      it("it should return the state with that item in array", () => {
        expect(
          reducer(
            { Items: [], Cart: [{ itemId: 1 }], loading: null, filter: [] },
            { type: types.DELETE_ITEM_INCART, payload: 2 }
          )
        ).toEqual({
          Items: [],
  ...
  describe("CLEAR_CART", () => {
    it("should return the state with no items in cart", () => {
      expect(reducer(undefined, { type: types.CLEAR_CART })).toEqual({
        Items: [],
        Cart: [],
        loading: null,
        filter: [],
